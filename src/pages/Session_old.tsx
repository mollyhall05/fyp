    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-muted800">Session not found</h2>
          <p className="mt-2 text-muted600">The requested session could not be found or you don't have permission to view it.</p>
          <Button 
